...
class MaterialUiPhoneNumber extends React.Component {
  ...
  constructor(props) {
    ...
    let preferredCountries = filter(filteredCountries, (country) => some(props.preferredCountries, (preferredCountry) => preferredCountry === country.iso2));
  ...
  getDropdownProps = () => {
    const {
      selectedCountry, anchorEl, preferredCountries,
    } = this.state;

    let { onlyCountries } = this.state;
    ...
    onlyCountries = onlyCountries.sort((a, b) => {
      return (
